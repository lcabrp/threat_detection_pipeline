...
MAX_MEMORY_GB = 8  # Hard limit for the benchmark
...
def setup_modin():
    """Initialize Modin with Ray backend for stability"""
    cfg.Engine.put("ray")  # Use Ray instead of Dask
    cfg.NPartitions.put(2)  # Reduce partitions for stability
    logging.getLogger("modin").setLevel(logging.CRITICAL)
